...
const Shopcard = ({genre,shopId,previewImage,verifyStatus,shopProfile,shopName,shopRating,reviewCount,shopDescription,startBudget,stopBudget}) => {
  const max3lines = {
    display: '-webkit-box',
    WebkitLineClamp: 3,
  ...
  return (
    <div onClick={() => alert("shopID is : " + shopId)} className='flex flex-col items-center m-4 w-[400px] h-[500px] rounded-sm border-[1px] shadow-md'>       {/* Shop preview picture */}
      ...
      <div className='flex justify-start relative mt-6 w-[368px] h-[60px]'>
        ...
        <div className='flex flex-col ml-4 w-60 h-100'>
          <div className='flex justify-start items-center h-[30px]'>
            ...
            {
              verifyStatus && <img className='w-[28px] h-[28px] ml-2' src="https://cdn-icons-png.flaticon.com/128/11412/11412145.png" alt="" />
            }
          </div>
          <div className='flex justify-start items-center h-[30px]'>
            <Stack spacing={1}>
      ...
      {/* Genre */}
      <div className='w-[348px] mt-4 text-xl font-bold'>Specialized at {genre}</div>
