...
const Filterbar = () => {
  ...
  return (
    <div
      ...
      className='w-full pb-12 mb-1 md:px-16 2 sticky top-[60px] z-10 bg-white'
    >
      <div className='w-full h-full flex flex-col sm:flex-row justify-around items-end m-auto sm:px-4 px-16 sm:gap-8'>
        {/* Verified Dropdown */}
        <div className='w-full h-3/5 my-2 sm:my-0'>
