...
const ShopProfilePreviewPage = () => {
  ...
  return (
    <div className='px-5 h-full min-w-full flex justify-center'>
          ...
          <div className='w-full flex flex-col pt-3'>
            ...
            {buttonCount >= 0 && (
              <div className='pl-5'>
                ...
                <div className='my-3 mr-3 w-3/5'>
                  <TextField
                    defaultValue={orderTypes[0]?.name || ''}
                    required
                    label='Package Name (4-10 characters)'
                    fullWidth
                    slotProps={{ minLength: 1, maxLength: 10 }}
                  />
                </div>
                <div className='flex flex-row'>
                  <div className='my-3 mr-3 w-2/5'>
                    <TextField
                      defaultValue={orderTypes[0]?.price || ''}
                      required
                      label='Price (THB)'
                      fullWidth
                    />
                  ...
                  <div className='my-3 mr-3 w-2/5'>
                    <TextField
                      defaultValue={orderTypes[0]?.deadline || ''}
                      required
                ...
                <div className='my-3 mr-3 w-full'>
                  <TextField
                    defaultValue={orderTypes[0]?.detail || ''}
                    required
            ...
            {buttonCount >= 2 && (
              <div className='pl-5 pt-5'>
                ...
                <div className='my-3 mr-3 w-3/5'>
                  <TextField
                    defaultValue={orderTypes[1]?.name || ''}
                    required
                    label='Package Name (4-10 characters)'
                    fullWidth
                    slotProps={{ minLength: 1, maxLength: 10 }}
                ...
                <div className='flex flex-row'>
                  <div className='my-3 mr-3 w-2/5'>
                    <TextField
                      defaultValue={orderTypes[1]?.price || ''}
                      required
                      label='Price (THB)'
                      fullWidth
                    />
                  ...
                  <div className='my-3 mr-3 w-2/5'>
                    <TextField
                      defaultValue={orderTypes[1]?.deadline || ''}
                      required
                      label='Working time (days)'
                      fullWidth
                    />
                ...
                <div className='my-3 mr-3 w-full'>
                  <TextField
                    defaultValue={orderTypes[1]?.detail || ''}
                    required
                    label='Product Details'
                    fullWidth
                    multiline
            ...
            {buttonCount >= 3 && (
              <div className='pl-5 pt-5'>
                ...
                <div className='my-3 mr-3 w-3/5'>
                  <TextField
                    defaultValue={orderTypes[2]?.name || ''}
                    required
                    label='Package Name (4-10 characters)'
                    fullWidth
                    slotProps={{ minLength: 1, maxLength: 10 }}
                ...
                <div className='flex flex-row'>
                  <div className='my-3 mr-3 w-2/5'>
                    <TextField
                      defaultValue={orderTypes[2]?.price || ''}
                      required
                      label='Price (THB)'
                      fullWidth
                    />
                  ...
                  <div className='my-3 mr-3 w-2/5'>
                    <TextField
                      defaultValue={orderTypes[2]?.deadline || ''}
                      required
                      label='Working time (days)'
                      fullWidth
                    />
                ...
                <div className='my-3 mr-3 w-full'>
                  <TextField
                    defaultValue={orderTypes[2]?.detail || ''}
                    required
                    label='Product Details'
                    fullWidth
                    multiline
            ...
            {(buttonCount == 1 || buttonCount == 0) && (
              <button
                onClick={bt2Clicked}
                className='mt-4 border-[1px] h-10 shadow-lg font-medium rounded-lg hover:bg-gray-300'
              >
                Add Second Package
              </button>
            )}
