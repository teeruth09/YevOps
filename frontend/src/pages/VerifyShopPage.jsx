...
const Verifyshop = () => {
  ...
  const handleSubmit = () => navigate('/verifysent')
  ...
  return (
    <form action=''>
      <div className='w-[1200px] m-auto'>
        {/* Back Button */}
        <BackButton containerStyle='pt-12 ps-12 my-8' />
        ...
        {/* Submit/Cancel */}
        <div className='w-full flex flex-col justify-between my-12 gap-4 px-12'>
          <PrimaryButton className='text-xl rounded-lg' onClick={handleSubmit}>
            Submit Verification
          </PrimaryButton>
