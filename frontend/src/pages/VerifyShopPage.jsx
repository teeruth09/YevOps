                    ...
                    <div style={bottomShadowStyle} className='w-[1200px] h-[400px] flex flex-col justify-center items-center'>
                        ...
                        <div className='w-[90%] h-4/5 flex justify-start'>
                            <div className='flex flex-col mt-4 w-1/2'>
                                ...
                                <div>
                                    <div className='my-3'><TextField required label="Address" fullWidth /></div>
                                    <div className='flex flex-row'>
                                        <div className='my-3 mr-3 w-1/2'><TextField required label="Ket / Tumbol" fullWidth /></div>
                                        <div className='my-3 ml-3 w-1/2'><TextField required label="Kwang / Umper" fullWidth /></div>
                                    </div>
                                    <div className='flex flex-row'>
                                        <div className='my-3 mr-3 w-1/2'><TextField required label="Province" fullWidth /></div>
                                        <div className='my-3 ml-3 w-1/2'><TextField required label="Postal Number" fullWidth /></div>
                                    </div>
                                </div>
                    ...
                    <div style={bottomShadowStyle} className='w-[1200px] h-[400px] flex flex-col justify-center items-center'>
                        ...
                        <div className='w-[90%] h-4/5 flex justify-start'>
                            <div className='flex flex-col mt-4 w-1/2'>
                                ...
                                <div>
                                    <div className='my-3'><TextField required label="Name" fullWidth /></div>
                                    <div className='flex flex-row'>
                                        <div className='my-3 mr-3 w-2/5'><TextField required label="Phone Number" fullWidth /></div>
                                        <div className='my-3 ml-3 w-3/5'><TextField required label="ID card number" fullWidth /></div>
                                    </div>
                                </div>
                            ...
                            <div className='flex flex-col justify-between mt-4 w-1/2'>
                                ...
                                <div className='mt-2'>
                                    <div className='grid grid-cols-2'>
                                        ...
                                        <FormControlLabel control={<Checkbox />} label="Formal Dress" />
                                        <FormControlLabel control={<Checkbox />} label="School Uniform" />
                                        <FormControlLabel control={<Checkbox />} label="Cosplay" />
                                        <FormControlLabel control={<Checkbox />} label="Others" />
                                    </div>
                                </div>

                                <div className='w-full h-1/3 mt-4'><TextField label="Describe more about your product" fullWidth /></div>
                            </div>
